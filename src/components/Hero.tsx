  ...
  return (
    <section className="px-16 pt-10 flex flex-col items-center text-center relative z-10">
      ...
      <div className="frosted-glass p-3 pl-8 rounded-full flex items-center gap-6 w-[720px] mt-5 shadow-2xl">
        ...
        <button className="bg-gold text-navy px-8 py-4 rounded-full font-bold uppercase text-[12px] tracking-wider cursor-pointer hover:scale-105 transition-transform">
          Explore
        </button>
      </div>
    </section>
